...
[这里必须有点bgm](https://music.163.com/outchain/player?type=2&id=28830412&auto=1&height=32)
  
## 🤩-FASTER-🤩   
## 🤯?!HIGHER?!🤯   
## 😃!!STRONGER THAN BEFORE!!😃
![author](https://img.shields.io/badge/Maximize_coder-ZX__RAYER1124-blue)
![Nodejs](https://img.shields.io/badge/Nodejs_ver.-21.16.0-yellow)
...
![time_schedule](res/time_schedule.png)   
时间栏中只能填一个时间。格式为 **XX:XX:XX**，模式有**上线，下线**选择，设置好时刻表后软件会按照时刻表执行任务，实现定时上网下线的功能！！！  
同样，**别忘记点保存时间配置**   

## 还有😃  
如果你是电脑高玩，如果你觉得Github下载是在太慢，我还有一个`开发者版本`！！  
## 开发者版本使用说明💻  
### 最复杂的玩意😠   
**接下来和上文一点关系都没有，标准教程到上面就结束了**  
...
```commandline
npx electron ./node_modules/sgu_cnc
```
保存以后，**点击启动**  
